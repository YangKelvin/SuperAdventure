var roof = function () 
{   this.arraySize = [];
    this.component; Object.defineProperty(this, 'position', 
    {
        get : function () 
        { 
    ...
    {
        this.pic = new Framework.Sprite(define.imagePath + sprite); this.component = new Framework.polygonComponent(this.pic,box2D.bodyType_Dynamic, box2D, this.arraySize);
